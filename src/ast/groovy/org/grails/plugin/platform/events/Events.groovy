...
interface Events {
    ...
    EventReply event(String namespace, String topic, def data)
    EventReply event(String namespace, String topic, def data, Map params)
    EventReply event(String namespace, String topic, def data, Map params, Closure callback)
